...
//!
//! ```no_run
//! use exarrow_rs::import::{import_from_parquet, ParquetImportOptions};
//! use std::path::Path;
//!
//! # async fn example() -> Result<(), Box<dyn std::error::Error>> {
//! // Import a Parquet file into a table
//! // let rows = import_from_parquet(&mut session, "my_table", Path::new("data.parquet"), Default::default()).await?;
